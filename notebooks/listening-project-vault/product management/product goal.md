i want to have a product that uses the data spotify and/or apple music gives users to determine unique insights. my big and main idea right now is a pick rates. it essentially asks: when given the choice, how many times (in a percentage) do i choose x artist, song, genre, etc different intervals of time? 
